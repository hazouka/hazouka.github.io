        document.addEventListener("alpine:init", () => {
            ...
            Alpine.data("blogApp", () => ({
                ...
                async insertImageMarkdown(file) {
                    ...
                    const savedKB =
                        file.size > compressed.size
                            ? ` (${Math.round(file.size / 1024)}KB ├óΓÇáΓÇÖ ${Math.round(compressed.size / 1024)}KB)`
                            : "";
                    this.showMsg(
                        "Image added" + savedKB + " ├óΓé¼ΓÇ¥ will upload on Save",
                        "ok",
                    );
                },
                ...
                async savePost(options = {}) {
                    ...
                    if (!silent) {
                        if (synced) {
                            this.showMsg("Saved to GitHub ├ó┼ôΓÇ£", "ok");
                ...
                async deletePost(id) {
                    ...
                    if (synced) {
                        ...
                        this.showMsg("Deleted from GitHub Γ£ô", "ok");
                    } else {
